...
public class VHotGrid2Adapter extends DelegateAdapter.Adapter {
    ...
    public VHotGrid2Adapter(Context context, LayoutHelper helper, List<MainGodsBean> mhotlist) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.item_cart_hot_gridb, parent, false);
    ...
    public void onBindViewHolder(final RecyclerView.ViewHolder holder, int position) {
        ...
        yiqianggou = (TextView) holder.itemView.findViewById(R.id.yiqianggou);
...
//        }else{
//            yiqianggoub.setLayoutParams(new LinearLayout.LayoutParams(0,LinearLayout.LayoutParams.MATCH_PARENT,0));
//        }
//        baifenbib.setLayoutParams(new LinearLayout.LayoutParams(0,LinearLayout.LayoutParams.MATCH_PARENT,carChoiceBean.stock-carChoiceBean.sales));
