 ...
 */
//重写一个RadioGroup 用来扩展RadioGroup包含的布局
public class BigRadioGroup extends LinearLayout {
    ...
    public BigRadioGroup(Context context) {
        super(context);
        setOrientation(VERTICAL);
        init();
    }

    public BigRadioGroup(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }
    ...
    public LayoutParams generateLayoutParams(AttributeSet attrs) {
        return new BigRadioGroup.LayoutParams(getContext(), attrs);
    }
    ...
    protected boolean checkLayoutParams(ViewGroup.LayoutParams p) {
        return p instanceof BigRadioGroup.LayoutParams;
    }
    ...
    public interface OnCheckedChangeListener {
         ...
         */
        public void onCheckedChanged(BigRadioGroup group, int checkedId);
    }
    ...
    private class PassThroughHierarchyChangeListener implements
        ...
        public void onChildViewAdded(View parent, View child) {
            if (parent == BigRadioGroup.this && child instanceof RadioButton) {
                int id = child.getId();
            ...
            } else if (parent == BigRadioGroup.this
