...
public class VHotSingle2Adapter extends DelegateAdapter.Adapter {
    ...
    public VHotSingle2Adapter(Context context, LayoutHelper helper, List<RecommendHotBean> mHotRecommendList) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.item_cart_hotrb, parent, false);
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        if(manager==null){
            ...
            mCarBeanAdapter = new RecyclerCommonAdapter<RecommendHotBean>(context, R.layout.item_cart_hotr3, mHotRecommendList) {
