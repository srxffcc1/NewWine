 ...
 * @Date: 2018/2/6 20:50
 */
public class CityPickerDialogFragmentCopy extends DialogFragment implements TextWatcher,
     ...
     * @return
     */
    public static CityPickerDialogFragmentCopy newInstance(boolean enable){
        final CityPickerDialogFragmentCopy fragment = new CityPickerDialogFragmentCopy();
