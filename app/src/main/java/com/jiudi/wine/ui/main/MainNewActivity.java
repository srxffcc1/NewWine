...
import com.jiudi.wine.adapter.vp.VpFragmentAdapter;
import com.jiudi.wine.base.BaseActivity;
import com.jiudi.wine.bean.UserBean;
import com.jiudi.wine.event.CloseMainEvent;
import com.jiudi.wine.event.FlashEvent;
...
import com.jiudi.wine.widget.NoTouchViewPager;
import com.jiudi.wine.widget.SpecialTab;
import com.jiudi.wine.widget.SpecialTabRound;
...
//                                Toast.makeText(mActivity, "请登录", Toast.LENGTH_SHORT).show();
        ...
        if (isdianzhu) {
            if(navigationController!=null){
                ...
                navigationController.setTitle(2,"代理权益");
            }
            ...
            if(navigationController!=null){
                ...
                navigationController.setTitle(2,"升级代理");
            }
        ...
        //判断手机号完善问题
        if(AccountManager.sUserBean!=null){
            long oldtime=(Long)SPUtil.get("poptime",0L);
            if(oldtime!=0){
                if(System.currentTimeMillis()-(oldtime)>1200000){
                    SPUtil.put("poptime",System.currentTimeMillis());
                    if("".equals(AccountManager.sUserBean.phone)||"null".equals(AccountManager.sUserBean.phone)||AccountManager.sUserBean.phone==null){
                        Toast.makeText(mActivity,"需要完善注册信息",Toast.LENGTH_SHORT).show();
