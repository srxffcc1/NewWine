...
public class VHotGridAdapter extends DelegateAdapter.Adapter {
    public Context context;
    private LayoutHelper helper;
    private List<MainGodsBean> mhotlist;
    private int fujian_px=0;

    public VHotGridAdapter(Context context, LayoutHelper helper, List<MainGodsBean> mhotlist) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.item_cart_hot_grid, parent, false);
