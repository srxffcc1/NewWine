...
import com.jiudi.wine.bean.TuanDui;
                ...
                try {
                    ...
                    if (code == 200) {
                        ...
                        if("1".equals(getArguments().getString("type"))){
                            titleCase.setText("您的粉丝中有"+data.optString("number").replace("null","0")+"位成为了代理，为您分成累计"+data.optString("total_money").replace("null","0")+"元");
                        }else{
