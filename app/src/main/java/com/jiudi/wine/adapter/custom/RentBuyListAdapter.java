package com.jiudi.wine.adapter.custom;

import android.support.v7.widget.RecyclerView;
import android.view.ViewGroup;

/**
 * Created by maqing on 2017/12/6.
 * Email:2856992713@qq.com
 */
public class RentBuyListAdapter extends RecyclerView.Adapter {
    @Override
...
//
//    public RentBuyListAdapter(Context context, List<HouseBean> houseList) {
//        mContext = context;
...
//            case RENT_HOUSE:
//                viewHolder = new RentViewHolder(mInflater.inflate(R.layout.item_rent_source, null));
//                break;
//            case BUY_HOUSE:
//                viewHolder = new BuyViewHolder(mInflater.inflate(R.layout.item_buy_source, null));
//                break;
//        }
//        return viewHolder;
//    }
