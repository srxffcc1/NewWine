...
public class BannerLayout extends RelativeLayout {
     ...
     * 一张图片是否可以滑动
     */
    private boolean oneCanSlide = true;
    ...
    private void init(AttributeSet attrs, int defStyle) {
        ...
        oneCanSlide=array.getBoolean(R.styleable.BannerLayoutStyle_oneCanSlide,oneCanSlide);
        array.recycle();
    ...
    public void setViews(final List<View> views) {
        ...
        LoopPagerAdapter pagerAdapter = new LoopPagerAdapter(views,oneCanSlide);
     ...
     * @param oneCanSlide
     */
    public void setOneCanSlide(boolean oneCanSlide) {
        this.oneCanSlide = oneCanSlide;
    }
    ...
    public class LoopPagerAdapter extends PagerAdapter {
        ...
        private boolean oneCanSlide;

        public LoopPagerAdapter(List<View> views, boolean onCanSlide) {
            this.views = views;
            this.oneCanSlide = onCanSlide;
        }

        @Override
        public int getCount() {
            if (oneCanSlide || views.size() > 1) {
