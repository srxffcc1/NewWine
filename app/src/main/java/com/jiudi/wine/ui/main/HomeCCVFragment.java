 ...
 * 主页
 */
public class HomeCCVFragment extends BaseFragment implements View.OnClickListener, LoadMoreAdapter.OnLoadMoreListener, SwipeRefreshLayout.OnRefreshListener, VHotTabAdapter.TabSelectedListener {
