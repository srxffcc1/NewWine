...
import com.jiudi.wine.widget.BannerLayout;
...
public class HomeFragment extends BaseFragment implements View.OnClickListener {
    ...
    private com.jiudi.wine.widget.SimpleLoadView loadmoreview;
    private int page=0;
