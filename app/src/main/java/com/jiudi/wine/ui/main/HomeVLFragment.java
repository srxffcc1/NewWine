 ...
 * 主页
 */
public class HomeVLFragment extends BaseFragment implements View.OnClickListener, LoadMoreAdapter.OnLoadMoreListener, SwipeRefreshLayout.OnRefreshListener, VHotTabAdapter.TabSelectedListener {
