...
public class OrderDetail {
    ...
    public String refund_reason_time;
    public String refund_reason_wap;
    ...
    public String back_integral;
    public String mark;
    public String is_del;
    public String unique;
    public String remark;
    public String mer_id;
    public String is_mer_check;
    ...
    public void setIs_mer_check(String is_mer_check) {
