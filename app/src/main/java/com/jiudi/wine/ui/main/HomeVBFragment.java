...
import com.jiudi.wine.adapter.vl.VHotAdapter;
...
import com.jiudi.wine.adapter.vl.VHotSingleAdapter;
 ...
 * 主页
 */
public class HomeVBFragment extends BaseFragment implements View.OnClickListener, LoadMoreAdapter.OnLoadMoreListener, SwipeRefreshLayout.OnRefreshListener, VHotTabAdapter.TabSelectedListener {
...
//            vHotAdapter = new VHotAdapter(mActivity, singleLayoutHelper, mRecommendImgList);
...
//            nowindex += vHotHead2Adapter.getItemCount();
            vHotSingleAdapter = new VHotSingleAdapter(mActivity, singleLayoutHelper, mHotRecommendList);
